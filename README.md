...
Doing this makes a gopher connections *appear* like a normal HTTP request from the perspective of the WSGI application. It also gives you hooks that can be used from within Flask routes.
